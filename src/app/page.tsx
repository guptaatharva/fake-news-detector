    ...
    <div className="min-h-screen bg-black text-white selection:bg-teal-500/30">
      ...
      <main className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          <Badge variant="outline" className="mb-6 border-white/20 text-teal-300 bg-white/5 backdrop-blur-sm px-4 py-1.5 text-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Button size="lg" className="h-14 px-8 text-base bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-400 hover:to-blue-500 border-0 rounded-full text-white shadow-[0_0_40px_rgba(20,184,166,0.3)] transition-all hover:scale-105">
              Start Verifying Free
            </Button>
            <Button size="lg" variant="outline" className="h-14 px-8 text-base border-white/20 hover:bg-white/10 rounded-full transition-all">
              See How It Works
            </Button>
          </div>
          ...
          <div className="mt-20 w-full max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl shadow-2xl relative">
            ...
            <div className="h-[400px] w-full rounded-xl bg-[#0a0a0a] border border-white/5 flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <p className="text-gray-400 font-mono text-sm">Analyzing source credibility...</p>
